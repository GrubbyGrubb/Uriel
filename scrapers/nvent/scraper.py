...
BASE_URL = "https://www.nvent.com"
SEARCH_URL = BASE_URL + "/en-au/search?search={}"
...
def scrape(sku: str) -> dict:
    try:
        ...
        link_tag = soup.select_one("a.search-result__title-link")
        ...
        price_tag = product_soup.select_one("span.price")

        if not price_tag:
            return _fail(sku, "Price not found or not shown")
